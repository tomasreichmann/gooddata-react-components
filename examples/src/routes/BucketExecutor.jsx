...
export const BucketExecutor = () => (
    <div>
        ...
        <p>
            The BucketExecutor component allows you to execute measures and attributes in the same format as for example ColumnChart &quot;measures&quot; and &quot;viewBy&quot; props.
            You need to specify required structure using the &quot;dimensions&quot; prop in a two dimensional array.
            First dimension specifies rows of data, second dimension specifies columns of data.
            Execution results are sent to a custom children function. You can use the BucketExecutor component to create visualizations using 3rd party libraries.
        </p>
