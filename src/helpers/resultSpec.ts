...
const generateDefaultDimensionsFromBuckets =
    (buckets: VisualizationObject.IBucket[]) => generateDefaultDimensions(convertBucketsToAFM(buckets));

export function getResultSpec(
    buckets: VisualizationObject.IBucket[],
    sortBy: AFM.SortItem[] = null,
    getDimensions: (afm: VisualizationObject.IBucket[]) => AFM.IDimension[] = generateDefaultDimensionsFromBuckets
): AFM.IResultSpec {
